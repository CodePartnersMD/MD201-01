...
But in this case, BusMall catalogs are placed on DMV regional transit system buses and metro.
...
The Target date for this milestone is 11:59pm 7/19/18.  Your instructors will be expecting the technical requirements to be met by that date, with regular and descriptive commit messages and merged into master/dev branch.  
